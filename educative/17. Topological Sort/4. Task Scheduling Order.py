...
def find_order(tasks, prerequisites):
    ...
    if len(scheduleOrder) != tasks: # important for the cycle finding
        return []
...
def main():
    print("Scheduling order:" + str(find_order(3, [[0, 1], [1, 2]])))
    print("Scheduling order:" + str(find_order(3, [[0, 1], [1, 2], [2, 0]]))) # none will have indgree one
    print("Scheduling order:" + str(find_order(6, [[2, 5], [0, 5], [0, 4], [1, 4], [3, 2], [1, 3]])))
main()
